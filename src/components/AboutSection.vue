<template>
  <section id="about" class="py-16 bg-white text-gray-800 px-4" data-aos="fade-up">
...
<script setup>
import about from "@/assets/images/programming.svg";
...
const skills = [
  ...
  { name: "API Development", icon: "fa-solid fa-plug" },
